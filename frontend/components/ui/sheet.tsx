...
function SheetTrigger({ asChild, children, ...props }: SheetPrimitive.Trigger.Props & { asChild?: boolean }) {
  if (asChild) {
    return <SheetPrimitive.Trigger data-slot="sheet-trigger" render={children as any} {...props} />
  }
...
function SheetClose({ asChild, children, ...props }: SheetPrimitive.Close.Props & { asChild?: boolean }) {
  if (asChild) {
    return <SheetPrimitive.Close data-slot="sheet-close" render={children as any} {...props} />
  }
