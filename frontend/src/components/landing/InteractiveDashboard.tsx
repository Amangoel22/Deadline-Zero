...
import { Target, Clock, Calendar, CheckCircle2, AlertTriangle, BarChart3, Activity, Focus, Smartphone } from 'lucide-react';
  ...
  return (
    <LayoutGroup>
      <div className={cn(
        ...
        >
          <div className="flex items-center gap-3 mb-8 px-2 whitespace-nowrap">
            <img
              src="/logo.png"
              alt="Deadline Zero"
