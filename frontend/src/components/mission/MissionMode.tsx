...
import { CheckCircle2, Circle, Ticket, Shield, Clock, X, ChevronRight, Play, Trophy, AlertTriangle, Coffee, Bot, FileText, Target } from 'lucide-react';
...
export default function MissionMode({ task, onClose, onFinish, onInterrupt }: MissionModeProps) {
  ...
  const defaultResources = (() => {
    ...
    if (task.category === "College")
      return ['YouTube', 'PDF Notes', 'ChatGPT', 'Google'];
    if (task.category === "Work")
      return ['Google Docs', 'Grammarly', 'ChatGPT'];
